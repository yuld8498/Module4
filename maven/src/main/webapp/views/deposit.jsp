        ...
        <form class=" table container-fluid w-90">
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="w-100" id="phone" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label font-weight-bold">Transaction Amount ($)</label>
                    <input type="text" class="w-100" id="address">
                </div>
...
<script src="https://kit.fontawesome.com/dccec83b30.js" crossorigin="anonymous">
